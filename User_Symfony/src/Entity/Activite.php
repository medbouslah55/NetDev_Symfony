 ...
 * Activite
 *
 * @ORM\Table(name="activite", indexes={@ORM\Index(name="FK_act_coach", columns={"cin_coach"}), @ORM\Index(name="FK_act_centre", columns={"id_centre"})})
 * @ORM\Entity
 */
class Activite
{
     ...
     * @var int|null
     *
     * @ORM\Column(name="cin_coach", type="integer", nullable=true)
     */
    private $cinCoach;
    ...
    public function getCinCoach(): ?int
    {
        return $this->cinCoach;
    }

    public function setCinCoach(?int $cinCoach): self
    {
